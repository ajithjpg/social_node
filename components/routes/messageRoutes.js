...
const { check_participant,getmessages,getchathistory,update_read,getchatlist} = require('../controller/messagecontroller')
const {isAuth} = require('../validator')

router.get('/:userId',isAuth,getmessages)

router.get('/getconversation/:userId',isAuth,getchathistory)
